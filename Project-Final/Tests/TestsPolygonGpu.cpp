...
#else
        NUMBER_T    polygons_begin[]    = {
            0,  4,  8, 12, 17, 21, 26, 30, 34, 39 };

        NUMBER_T    polygons_end[]      = {
            4,  8, 12, 17, 21, 26, 30, 34, 39, 44 };
