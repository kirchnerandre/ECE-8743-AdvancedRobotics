...
function Result = hit_triangle(AB, P0, P1, P2)
    ...
    elseif hit_line_segment(AB, [P2; P0]) == true
        ...
        vector_01 = [ P1(1) - P0(1); P1(2) - P0(2); 0];
        vector_12 = [ P2(1) - P1(1); P2(2) - P1(2); 0];
        vector_20 = [ P0(1) - P2(1); P0(2) - P2(2); 0];

        vector_0a = [ AB(1, 1) - P0(1); AB(1, 2) - P0(2); 0];
        vector_1a = [ AB(1, 1) - P1(1); AB(1, 2) - P1(2); 0];
        vector_2a = [ AB(1, 1) - P2(1); AB(1, 2) - P2(2); 0];

        vector_0b = [ AB(2, 1) - P0(1); AB(2, 2) - P0(2); 0];
        vector_1b = [ AB(2, 1) - P1(1); AB(2, 2) - P1(2); 0];
        vector_2b = [ AB(2, 1) - P2(1); AB(2, 2) - P2(2); 0];

        cross_0a_01 = cross(vector_0a, vector_01);
        cross_1a_12 = cross(vector_1a, vector_12);
        cross_2a_20 = cross(vector_2a, vector_20);

        cross_0b_01 = cross(vector_0b, vector_01);
        cross_1b_12 = cross(vector_1b, vector_12);
        cross_2b_20 = cross(vector_2b, vector_20);
    
        if ((cross_0a_01(3) > 0) && (cross_1a_12(3) > 0) && (cross_2a_20(3) > 0)) ...
        || ((cross_0a_01(3) < 0) && (cross_1a_12(3) < 0) && (cross_2a_20(3) < 0))
            Result = true;
        elseif ((cross_0b_01(3) > 0) && (cross_1b_12(3) > 0) && (cross_2b_20(3) > 0)) ...
            || ((cross_0b_01(3) < 0) && (cross_1b_12(3) < 0) && (cross_2b_20(3) < 0))
            Result = true;
        end
    end
end
